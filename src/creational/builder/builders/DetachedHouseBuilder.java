...
public class DetachedHouseBuilder implements Builder
{
    ...
    public DetachedHouse getResult()
    {
        return new DetachedHouse(houseType,houseColor,bathroom,bedrooms,kitchen,livingRoom);
    }
